...
//        this.pickUpLocation = pickUpLocation;
    ...
    public void checkAvailableCabs() {
        ...
        // fixme Fisrt page open call
        HashMap<String, String> parameters = new HashMap<String, String>();
        parameters.put("type", "loadAvailableCab");
        //  fixme again second call put location
...
//        }
        ...
        Logger.d("GeocodeParameter","::"+parameters.toString());
...
//                loadDriverDetails(listOfDrivers.get(i));
    ...
    public void loadDriverDetails(final HashMap<String, String> map) {
        ...
        ((TextView) dialog.findViewById(R.id.nameTxt)).setText(map.get("Name") + " " + map.get("LastName"));

        ((TextView) dialog.findViewById(R.id.milesTxt)).setText(map.get("DIST_TO_PICKUP_INT") + " " + map.get("LBL_KM_DISTANCE_TXT"));


        ((TextView) dialog.findViewById(R.id.milesawayTxt)).setText(map.get("LBL_AWAY"));

        ((TextView) dialog.findViewById(R.id.reviewTxt)).setText(map.get("PROVIDER_RATING_COUNT") + " " + generalFunc.retrieveLangLBl("Reviews", "LBL_REVIEWS"));
...
//        ImageView backCoverImage = (ImageView) dialog.findViewById(R.id.backCoverImage);
        ...
        if (map.get("fAmount") != null && !map.get("fAmount").trim().equals("") && !map.get("fAmount").trim().equals("0")) {
            ((TextView) dialog.findViewById(R.id.priceTxt)).setText(map.get("fAmount"));
        } else {
            (dialog.findViewById(R.id.priceTxt)).setVisibility(View.GONE);
        }

        TextView minHourTxtView = ((TextView) dialog.findViewById(R.id.minHourTxtView));
        ...
        if (map.get("tProfileDescription") != null && !map.get("tProfileDescription").equals("")) {
            ((TextView) dialog.findViewById(R.id.descTxt)).setText(map.get("tProfileDescription"));
        } else {
            ((TextView) dialog.findViewById(R.id.descTxt)).setText("----------");

        }
        ((TextView) dialog.findViewById(R.id.descHTxt)).setText(generalFunc.retrieveLangLBl("ABOUT EXPERT", "LBL_ABOUT_EXPERT"));
        ...
        ((TextView) dialog.findViewById(R.id.driverDTxt)).setText(generalFunc.retrieveLangLBl("Washer Detail", "LBL_DRIVER_DETAIL"));
