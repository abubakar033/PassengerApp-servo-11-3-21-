...
import com.servo.user.BusinessProfileActivity;
import com.servo.user.CardPaymentActivity;
import com.servo.user.ContactUsActivity;
import com.servo.user.EmergencyContactActivity;
import com.servo.user.HelpActivity;
import com.servo.user.HistoryActivity;
import com.servo.user.InviteFriendsActivity;
import com.servo.user.MainActivity;
import com.servo.user.MyBookingsActivity;
import com.servo.user.MyProfileActivity;
import com.servo.user.MyWalletActivity;
import com.servo.user.NotificationActivity;
import com.servo.user.OnGoingTripsActivity;
import com.servo.user.R;
import com.servo.user.StaticPageActivity;
...
import com.servo.user.deliverAll.EditCartActivity;
import com.servo.user.deliverAll.LoginActivity;
...
public class AddDrawer implements AdapterView.OnItemClickListener {
    ...
    public TextView walletbalncetxt;
    Context mContext;
    View view;
    ...
    public AddDrawer(Context mContext, String userProfileJson, boolean isback) {
        ...
        walletbalncetxt = (TextView) view.findViewById(R.id.walletbalncetxt);
    ...
    public void onItemClick(AdapterView<?> parent, final View view, int position, long id) {
        ...
        switch (itemId) {
            ...
            case Utils.MENU_ONGOING_TRIPS:
                ...
                new StartActProcess(mContext).startActForResult(OnGoingTripsActivity.class, bn, Utils.ASSIGN_DRIVER_CODE);
                break;
