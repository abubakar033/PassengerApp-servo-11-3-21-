...
public class ConfigSCConnection implements BasicListener, GetLocationUpdates.LocationUpdates, UpdateFrequentTask.OnTaskRunCalled {
    ...
    ShowToast showToast;
    public ConfigSCConnection() {
    }

    public ConfigSCConnection(ShowToast showToast) {
...
//            startReConnectionTask();
        ...
        showToast.callToast("DisConnected");


        Logger.d("SocketApp", "DisConnected");
        Logger.d("SocketApp", "closedByServer::" + closedByServer);
        Logger.d("SocketApp", "socket::" + socket);
        Logger.d("SocketApp", "serverCloseFrame::" + serverCloseFrame);
    }
...
//            startReConnectionTask();
    ...
    public void onAuthentication(Socket socket, Boolean status) {
        Logger.d("SocketApp", "status::" + status);
