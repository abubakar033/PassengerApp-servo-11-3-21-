...
public class CustomDialog {
    ...
    TextView tv_Proceed_Button;
    TextView tv_Positive_Button;
    TextView tv_Negative_Button;
    ...
    protected void createCustomDialog() {
        ...
        final TextView tv_title = (TextView) customDialog.findViewById(R.id.tv_title);
        final TextView tv_message = (TextView) customDialog.findViewById(R.id.tv_message);
        ...
        tv_Proceed_Button = (TextView) customDialog.findViewById(R.id.tv_Proceed_Button);
        tv_Cancel_Button = (TextView) customDialog.findViewById(R.id.tv_Cancel_Button);
        tv_Positive_Button = (TextView) customDialog.findViewById(R.id.tv_Positive_Button);
        tv_Negative_Button = (TextView) customDialog.findViewById(R.id.tv_Negative_Button);
