...
import com.servo.user.RatingActivity;
...
public class OpenMainProfile {
    ...
    public void setGeneralData() {
        ...
        ExecuteWebServerUrl.ENABLE_GOOGLE_API_ROUTE = generalFun.getJsonValueStr("ENABLE_GOOGLE_API_ROUTE", userProfileJsonObj).equalsIgnoreCase("Yes");
        ...
        storeData.put("ENABLE_GOOGLE_API_OPTIMIZATION", generalFun.getJsonValueStr("ENABLE_GOOGLE_API_OPTIMIZATION", userProfileJsonObj));
        storeData.put("ENABLE_GOOGLE_API_OPTIMIZATION_ON_FARE_EST", generalFun.getJsonValueStr("ENABLE_GOOGLE_API_OPTIMIZATION_ON_FARE_EST", userProfileJsonObj));
