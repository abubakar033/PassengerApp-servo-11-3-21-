...
public class ExecuteWebServerUrl {
    ...
    public static boolean ENABLE_GOOGLE_API_ROUTE = false;
    ...
    public ExecuteWebServerUrl(Context mContext, String directUrl, boolean directUrl_value) {
        ...
        if (directUrl.startsWith("https://maps.googleapis.com") && ENABLE_GOOGLE_API_ROUTE) {
    ...
    public void setLoader(Context mContext, GeneralFunctions generalFunc) {
      //  this.isLoaderShown = isLoaderShown;
        this.generalFunc = generalFunc;
        this.mContext = mContext;
    }
        ...
        call.enqueue(new Callback<Object>() {
            ...
            public void onResponse(Call<Object> call, Response<Object> response) {
                if (response.isSuccessful()) {
                   ...
                   // Log.i(parameters.get("type"),responseString);
                    fireResponse();
                } else {
    ...
    public void performPostCall() {
        ...
        if (directUrl_value && (!directUrl.startsWith("https://maps.googleapis.com") || (directUrl.startsWith("https://maps.googleapis.com") && ENABLE_GOOGLE_API_ROUTE == false))) {
        ...
        Log.i("junigates",parametersObj==null?"e":parametersObj.toString());
        Log.i("junigates1",parameters==null?"e1":parameters.toString());
