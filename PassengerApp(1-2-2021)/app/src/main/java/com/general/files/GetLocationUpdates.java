...
public class GetLocationUpdates extends LocationCallback {
    ...
    public GetLocationUpdates(Context context, int displacement, boolean isContinuousLocUpdates,
                              boolean isInitializeFromNonActivityClass, LocationUpdates locationsUpdates) {
        // TODO Auto-generated constructor stub
        this.mContext = context;
