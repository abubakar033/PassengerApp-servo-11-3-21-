...
//        }
        ...
        try {
            client.connect(getGeneralFunc().retrieveValue(Utils.YALGAAR_CLIENT_KEY), false,
                    (generalFunc.retrieveValue(Utils.DEVICE_SESSION_ID_KEY).equals("") ? generalFunc.getMemberId() :
                            generalFunc.retrieveValue(Utils.DEVICE_SESSION_ID_KEY)), yalgaarResponseListener);
        } catch (Exception e) {
            e.printStackTrace();
        }
