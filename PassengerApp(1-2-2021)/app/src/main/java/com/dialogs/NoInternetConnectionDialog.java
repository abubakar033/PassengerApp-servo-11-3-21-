...
public class NoInternetConnectionDialog /*implements UpdateFrequentTask.OnTaskRunCalled*/ {
    ...
    public void show() {
        ...
        ((TextView) dialogNoInternetConnection.findViewById(R.id.noLocTitleTxt)).setText(generalFunc.retrieveLangLBl("", "LBL_NO_INTERNET_TITLE"));
        ((TextView) dialogNoInternetConnection.findViewById(R.id.noLocMsgTxt)).setText(generalFunc.retrieveLangLBl("", "LBL_NO_INTERNET_SUB_TITLE"));
        ((TextView) dialogNoInternetConnection.findViewById(R.id.settingTxt)).setText(generalFunc.retrieveLangLBl("", "LBL_SETTINGS"));
        ((TextView) dialogNoInternetConnection.findViewById(R.id.pickupredirectTxt)).setVisibility(View.GONE);
        ((TextView) dialogNoInternetConnection.findViewById(R.id.pickupredirectTxt)).setOnClickListener(null);
