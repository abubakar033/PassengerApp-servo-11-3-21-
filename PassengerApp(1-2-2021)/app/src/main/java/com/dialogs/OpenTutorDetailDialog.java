...
public class OpenTutorDetailDialog {
    ...
    public void show() {
        ...
        ((TextView) dialogView.findViewById(R.id.rateTxt)).setText(data_trip.get("driverRating"));
        ((TextView) dialogView.findViewById(R.id.nameTxt)).setText(data_trip.get("driverName"));
        vName = data_trip.get("driverName");

        ((TextView) dialogView.findViewById(R.id.tutorDTxt)).setText(generalFunc.retrieveLangLBl("Tutor Detail", "LBL_DRIVER_DETAIL"));
        ((TextView) dialogView.findViewById(R.id.callTxt)).setText(generalFunc.retrieveLangLBl("", "LBL_CALL_TXT"));
        ((TextView) dialogView.findViewById(R.id.msgTxt)).setText(generalFunc.retrieveLangLBl("", "LBL_MESSAGE_TXT"));
    ...
    public void sinchCall() {
        ...
        if (!generalFunc.isCallPermissionGranted(false)) {
            ...
            OnGoingTripDetailsActivity onGoingTripDetailsActivity = (com.servo.user.OnGoingTripDetailsActivity) MyApp.getInstance().getCurrentAct();
