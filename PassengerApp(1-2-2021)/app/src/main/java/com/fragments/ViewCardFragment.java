...
import static com.servo.user.R.id.demoText;
...
public class ViewCardFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (generalFunc.getJsonValue("SITE_TYPE", userProfileJson).equalsIgnoreCase("Demo")) {
            ...
            ((TextView) view.findViewById(demoText)).setText(builder, TextView.BufferType.SPANNABLE);
        } else {
            (view.findViewById(R.id.demoarea)).setVisibility(View.GONE);
            ((TextView) view.findViewById(demoText)).setVisibility(View.VISIBLE);
            ((TextView) view.findViewById(demoText)).setText(generalFunc.retrieveLangLBl("", "LBL_CARD_INFO_SECURE_NOTE"));
        }
...
//        String STRIPE_PUBLISH_KEY = generalFunc.getJsonValue("STRIPE_PUBLISH_KEY", userProfileJson);
        ...
        if (APP_PAYMENT_METHOD.equalsIgnoreCase("Stripe")) {
            ...
            if (vStripeCusId.equals("")) {
                ...
                ((TextView) view.findViewById(R.id.cardTxt)).setText(vCreditCard);
    ...
    public void setLabels() {
        ((TextView) view.findViewById(R.id.noCardAvailTxt)).setText(generalFunc.retrieveLangLBl("", "LBL_NO_CARD_AVAIL_NOTE"));
        ((TextView) view.findViewById(R.id.noCardAvailheadrTxt)).setText(generalFunc.retrieveLangLBl("NO CARD AVAILABLE.", "LBL_NO_CARD_AVAIL_HEADER_NOTE"));
        ((TextView) view.findViewById(R.id.demonoteText)).setText(generalFunc.retrieveLangLBl("", "LBL_NOTES"));
        ((TextView) view.findViewById(demoText)).setText(generalFunc.retrieveLangLBl("", "LBL_DEMO_CARD_DESC"));
