...
import com.servo.user.MyWalletHistoryActivity;
...
public class WalletFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        noTransactionTxt = (TextView) view.findViewById(R.id.noTransactionTxt);
        transactionsTxt = (TextView) view.findViewById(R.id.transactionsTxt);
        ...
        exeWebServer.setDataResponseListener(responseString -> {
            ...
            if (responseString != null && !responseString.equals("")) {
                ...
                if (generalFunc.checkDataAvail(Utils.action_str, responseString) == true) {
                    ...
                    ((TextView) view.findViewById(R.id.yourBalTxt)).setText(generalFunc.retrieveLangLBl("", "LBL_USER_BALANCE"));


                    ((TextView) view.findViewById(R.id.walletamountTxt)).setText(LBL_BALANCE);
