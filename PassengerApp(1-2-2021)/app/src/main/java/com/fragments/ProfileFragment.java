...
import com.servo.user.SearchPickupLocationActivity;
...
public class ProfileFragment extends Fragment {
   ...
   // MaterialEditText lNameBox;
    ...
    TextView homePlaceTxt, homePlaceHTxt;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
      ...
      //  lNameBox = (MaterialEditText) view.findViewById(R.id.lNameBox);
        ...
        homePlaceTxt = (TextView) view.findViewById(R.id.homePlaceTxt);
        homePlaceHTxt = (TextView) view.findViewById(R.id.homePlaceHTxt);
        workPlaceTxt = (TextView) view.findViewById(R.id.workPlaceTxt);
        workPlaceHTxt = (TextView) view.findViewById(R.id.workPlaceHTxt);
        placearea = (LinearLayout) view.findViewById(R.id.placearea);

// Deliver all

        verifytxt = (TextView) view.findViewById(R.id.verifytxt);
...
// Deliver all
    ...
    public void setLabels() {
       ...
       // lNameBox.setBothText(generalFunc.retrieveLangLBl("", "LBL_LAST_NAME_HEADER_TXT"));
        ...
        ((TextView) view.findViewById(R.id.placesTxt)).setText(generalFunc.retrieveLangLBl("", "LBL_PLACES_HEADER_TXT"));
