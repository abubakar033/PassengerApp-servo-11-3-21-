...
public class BusinessProfileListFragment extends Fragment {
    ...
    private void addFareDetailRow(HashMap<String, String> data, boolean isLast) {
        ...
        TextView profileNameTxt = (TextView) convertView.findViewById(R.id.profileNameTxt);
        TextView profileDescTxt = (TextView) convertView.findViewById(R.id.profileDescTxt);
        ...
        if (!vImage.equalsIgnoreCase("")) {
            Picasso.with(getActivity()).load(vImage).placeholder(R.mipmap.ic_no_icon).into(profileImage);
        }
