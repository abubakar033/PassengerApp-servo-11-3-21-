...
import com.servo.user.BusinessSetupActivity;
...
public class BusinessProfileIntroFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        noteHeading = (TextView) v.findViewById(R.id.noteHeading);
        noteTxt = (TextView) v.findViewById(R.id.noteTxt);
        ...
        if (!vWelcomeImage.equalsIgnoreCase("")) {
            Picasso.with(getActivity()).load(vWelcomeImage).placeholder(R.mipmap.ic_no_icon).into(introImage);
        }
        return v;
    }
