...
public class SupportActivity extends AppCompatActivity {
    ...
    TextView helpHTxt, contactHTxt, privacyHTxt, aboutusHTxt, termsHTxt, livechatHTxt;
    ...
    private void initView() {
        ...
        helpHTxt = (TextView) findViewById(R.id.helpHTxt);
        contactHTxt = (TextView) findViewById(R.id.contactHTxt);
        privacyHTxt = (TextView) findViewById(R.id.privacyHTxt);
        aboutusHTxt = (TextView) findViewById(R.id.aboutusHTxt);
        termsHTxt = (TextView) findViewById(R.id.termsHTxt);
        livechatHTxt = (TextView) findViewById(R.id.livechatHTxt);
