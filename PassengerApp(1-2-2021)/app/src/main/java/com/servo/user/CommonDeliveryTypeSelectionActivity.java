...
public class CommonDeliveryTypeSelectionActivity extends AppCompatActivity implements SubCategoryItemAdapter.setSubCategoryClickList, DeliveryBannerAdapter.OnBannerItemClickList {
    ...
    public void getDetails() {
        ...
        Log.d("OpenCatType","parametersCommonDev::"+parameters);
    ...
    protected void onResume() {
        ...
        if (addDrawer != null) {
            Logger.d("TRACK_FLOW","On Resume -> addDrawer!=null");
        ...
        if (iswallet) {
            if (addDrawer != null) {
                Logger.d("TRACK_FLOW","On Resume -> iswallet");
                addDrawer.changeUserProfileJson(userProfileJson);
            }
            iswallet = false;
        }
        ...
        if (addDrawer != null) {
            Logger.d("TRACK_FLOW","On Resume -> set walletbalncetxt");
    ...
    private void getLanguageLabelServiceWise() {
        ...
        Log.d("OpenCatType","CommonDeliveryTypeparameters"+parameters);
    ...
    public void itemSubCategoryClick(int position, String eDeliveryType, HashMap<String, String> dataMap) {
        Log.d("OpenCatType","CommonDeliveryTypeSelectionActivity"+eDeliveryType);
        Log.d("OpenCatType","CommonDeliveryTypeSelectionActivity"+dataMap);
    ...
    public void setUserInfo() {
        ...
        ((TextView) view.findViewById(R.id.userNameTxt)).setText(generalFunc.getJsonValue("vName", userProfileJson) + " "
                + generalFunc.getJsonValue("vLastName", userProfileJson));
        ((TextView) view.findViewById(R.id.walletbalncetxt)).setText(generalFunc.retrieveLangLBl("", "LBL_WALLET_BALANCE") + ": " + generalFunc.convertNumberWithRTL(generalFunc.getJsonValue("user_available_balance", userProfileJson)));
