...
public class MoreInfoActivity extends AppCompatActivity {
    ...
    TextView itemNpricecartTxt, viewCartTxt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView bottomViewDescTxt = (TextView) findViewById(R.id.bottomViewDescTxt);
        ...
        new CreateRoundedView(getActContext().getResources().getColor(R.color.appThemeColor_1), 5, 0, 0,  bottomViewDescTxt);
        ...
        material_tabs.setViewPager(view_pager);
