...
public class CarWashBookingDetailsActivity extends AppCompatActivity {
    ...
    TextView serviceTxt, driverNameTxt, bookDateHTxt, bookDateVTxt, booktimeHTxt, booktimeVTxt;
    View couponCodeArea;
    TextView applyCouponHTxt;
    LinearLayout promocodeArea;
    TextView promocodeappliedHTxt, promocodeappliedVTxt, appliedPromoHTxtView;
    ...
    TextView paymentHTxt, changePaymentTxt, locationHTxt, changeLocationTxt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bookDateHTxt = (TextView) findViewById(R.id.bookDateHTxt);
        bookDateVTxt = (TextView) findViewById(R.id.bookDateVTxt);
        booktimeHTxt = (TextView) findViewById(R.id.booktimeHTxt);
        booktimeVTxt = (TextView) findViewById(R.id.booktimeVTxt);
        applyCouponHTxt = (TextView) findViewById(R.id.applyCouponHTxt);
        paymentHTxt = (TextView) findViewById(R.id.paymentHTxt);
        locationHTxt = (TextView) findViewById(R.id.locationHTxt);
        changePaymentTxt = (TextView) findViewById(R.id.changePaymentTxt);
        changeLocationTxt = (TextView) findViewById(R.id.changeLocationTxt);
        ...
        userAddressTxt = (TextView) findViewById(R.id.userAddressTxt);
        addChangeLocImgView = (AppCompatImageView) findViewById(R.id.addChangeLocImgView);
        ...
        addChangeLocImgView.setOnClickListener(new setOnClickList());
        userAddressTxt.setVisibility(View.VISIBLE);
        addChangeLocImgView.setVisibility(View.VISIBLE);
        payImgView = (ImageView) findViewById(R.id.payImgView);
        payTypeTxt = (TextView) findViewById(R.id.payTypeTxt);
        selLocTxt = (TextView) findViewById(R.id.selLocTxt);
        selLocTxt.setText(generalFunc.retrieveLangLBl("", "LBL_AT_USER_LOCATION"));
        ...
        changeLocationTxt.setText(LBL_CHANGE);
        ...
        changeLocationTxt.setOnClickListener(new setOnClickList());
    ...
    public void addItemView(JSONArray itemArray) {
        ...
        for (int i = 0; i < itemArray.length(); i++) {
            ...
            QTYNumberTxtView.setText(generalFunc.getJsonValueStr("Qty", data));
            ...
            if (responseString != null && !responseString.equals("")) {
                ...
                if (isDataAvail) {
                    ...
                    if (generalFunc.getJsonValue("eEnableServiceAtProviderLocation", responseString).equalsIgnoreCase("Yes")) {
                        changeLocationTxt.setVisibility(View.VISIBLE);
                    } else {
                        changeLocationTxt.setVisibility(View.GONE);
                    }
                    ...
                    if (GeneralFunctions.parseIntegerValue(0, totalAddressCount) >= 1) {
                        addChangeLocImgView.setImageResource(R.mipmap.ic_edit);
                        addChangeLocImgView.setPaddingRelative(0, 0, 0, 0);
                    } else {
                        int padding = Utils.dipToPixels(getActContext(), 8);
                        addChangeLocImgView.setPaddingRelative(padding, padding, padding, padding);
                        addChangeLocImgView.setImageResource(R.drawable.ic_add_circle);
                    }

                    addItemView(generalFunc.getJsonArray(Utils.message_str, responseString));
    ...
    public void setLocationView() {
        if (isUserLocation) {
            ...
            iUserAddressId = "";
            userAddressTxt.setVisibility(View.VISIBLE);
            addChangeLocImgView.setVisibility(View.GONE);
    ...
    public void openPaymentDailog() {
        ...
        TextView paymentHTxt = (TextView) bottomSheetView.findViewById(R.id.paymentHTxt);
    ...
    public void openAddressSelectDailog() {
        ...
        TextView locationHTxt = (TextView) bottomSheetView.findViewById(R.id.paymentHTxt);
        TextView cancelTxt = (TextView) bottomSheetView.findViewById(R.id.cancelTxt);
        RadioButton userLocRadioBtn = (RadioButton) bottomSheetView.findViewById(R.id.cashRadioBtn);
        RadioButton providerLocradioBtn = (RadioButton) bottomSheetView.findViewById(R.id.cardRadioBtn);
    ...
    public class setOnClickList implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (i == R.id.backImgView) {
                ...
                openPaymentDailog();
            } else if (i == R.id.changeLocationTxt) {
                openAddressSelectDailog();

            } else if (i == R.id.addChangeLocImgView) {
                Bundle bn = new Bundle();
                ...
                if (isUserLocation) {
                    if (iUserAddressId.equals("")) {
                        generalFunc.showMessage(changeLocationTxt, generalFunc.retrieveLangLBl("", "LBL_SELECT_ADDRESS_TITLE_TXT"));
                        return;
                    }
                }
    ...
    public void openSurgeConfirmDialog(String message, String paymentType) {
        ...
        ((TextView) dialogView.findViewById(R.id.headerMsgTxt)).setText(generalFunc.retrieveLangLBl("", generalFunc.getJsonValue(Utils.message_str, message)));
        ((TextView) dialogView.findViewById(R.id.surgePriceTxt)).setText(generalFunc.convertNumberWithRTL(generalFunc.getJsonValue("SurgePrice", message)));
    ...
    public void checkOutStandingAmount(String message, String paymentType) {
        ...
        if (iscash && isDataAvail) {
            ...
            if (SYSTEM_PAYMENT_FLOW.equalsIgnoreCase("Method-1")) {
                if (!iswalletAdjustPopupShown && generalFunc.getJsonValue("eWalletBalanceAvailable", userProfileJson).equalsIgnoreCase("Yes")) {
