...
import com.servo.user.BaseActivity;
...
public class TrackOrderActivity extends BaseActivity implements OnMapReadyCallback {
    ...
    TextView pickedUpTimeTxtView;
    TextView pickedUpTimeAbbrTxtView;
    TextView pickedUpTxtView;
    TextView distanceVTxtView;
    TextView distanceVAbbrTxtView;
    ...
    TextView delTitleTxtView, delMsgTxtViewm, btn_help, btn_confirm, btn_help_txt, btn_confirm_txt, btn_cancel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        delTitleTxtView = (TextView) findViewById(R.id.delTitleTxtView);
        ...
        delMsgTxtViewm = (TextView) findViewById(R.id.delMsgTxtView);
        btn_help = (TextView) findViewById(R.id.btn_help);
        btn_cancel = (TextView) findViewById(R.id.btn_cancel);
        btn_help_txt = (TextView) findViewById(R.id.btn_help_txt);
        btn_confirm = (TextView) findViewById(R.id.btn_confirm);
        btn_confirm_txt = (TextView) findViewById(R.id.btn_confirm_txt);
        ...
        timeArea = (LinearLayout) findViewById(R.id.timeArea);

        new CreateRoundedView(getActContext().getResources().getColor(R.color.appThemeColor_1), 5, 0, 0, btn_cancel);

        pickedUpTimeTxtView = (TextView) findViewById(R.id.pickedUpTimeTxtView);
        pickedUpTimeAbbrTxtView = (TextView) findViewById(R.id.pickedUpTimeAbbrTxtView);
        pickedUpTxtView = (TextView) findViewById(R.id.pickedUpTxtView);
        distanceVTxtView = (TextView) findViewById(R.id.distanceVTxtView);
        distanceVAbbrTxtView = (TextView) findViewById(R.id.distanceVAbbrTxtView);
        distanceTxtView = (TextView) findViewById(R.id.distanceTxtView);
            ...
            if (messageStr.equalsIgnoreCase("OrderConfirmByRestaurant") || messageStr.equalsIgnoreCase("OrderPickedup")) {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        btnConfirmarea.setVisibility(View.INVISIBLE);
    ...
    public void generateMapLocations(double resLat, double resLong, double userLat, double userLong) {
        ...
        TextView restaurantMarkerTxtView = (TextView) restaurantMarkerView.findViewById(R.id.addressTxtView);
        ...
        TextView userMarkerTxtView = (TextView) userMarkerView.findViewById(R.id.addressTxtView);
        ...
        if (iDriverId.equalsIgnoreCase("")) {
            linePoly = gMap.addPolyline(polylineOptions);//done nthing
    ...
    private void buildArcLine(LatLng p1, LatLng p2, double arcCurvature) {
        ...
        if (!eDisplayDottedLine.equalsIgnoreCase("") && eDisplayDottedLine.equalsIgnoreCase("Yes")) {
            ...
            polyline = gMap.addPolyline(options.width(10).color(Color.BLACK).geodesic(false).pattern(pattern));//painding
        } else {
            if (polyline != null) {
                polyline.remove();
                polyline = null;
    ...
    // fixme Abubakar TrackOdrder Detail
                ...
                public void setResponse(String responseString) {
                    ...
                    if (responseString != null && !responseString.equals("")) {
                        ...
                        if (action.equals("1")) {
                            ...
                            ordertitleTxt.setText(generalFunctions.retrieveLangLBl("", "LBL_ORDER") + "#" + generalFunctions.convertNumberWithRTL(generalFunctions.getJsonValue("vOrderNo", responseString)) + "\n" + generalFunctions.convertNumberWithRTL(generalFunctions.getDateFormatedType(generalFunctions.getJsonValue("tOrderRequestDate", responseString), Utils.OriginalDateFormate, Utils.TrackDateFormatewithTime)) + " | " +
