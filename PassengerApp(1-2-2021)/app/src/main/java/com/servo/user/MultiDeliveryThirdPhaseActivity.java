...
public class MultiDeliveryThirdPhaseActivity extends AppCompatActivity implements MultiPaymentTypeRecyclerAdapter.OnTypeSelectListener {
    HashMap<String, String> mapData = new HashMap<>();

    TextView titleTxt;
    ImageView backImgView;
    GeneralFunctions generalFunc;
    TextView paymentTitle, payementModeTitle, codeTitle;
    ...
    private void init() {
        ...
        payementModeTitle = (TextView) findViewById(R.id.payementModeTitle);
...
//                    setCardSelection(false);
    ...
    private void addFareDetailLayout(JSONArray jobjArray) {
        ...
        for (int i = 0; i < jobjArray.length(); i++) {
            ...
            try {
                ...
                if (i == 0) {
                    ((TextView) findViewById(R.id.cartypeTxt)).setText(jobject.get(data).toString());
                } else {
    ...
    private void setSelected(String selected) {
        ...
        if (selected.equalsIgnoreCase("3")) {
            ...
            ((LinearLayout) findViewById(R.id.tabArea1)).setBackgroundColor(getResources().getColor(R.color.multi_tab_light_color));
            ...
            ((ImageView) findViewById(R.id.iv2)).setImageResource(R.drawable.multi_arrow_shape_normal);
            ((LinearLayout) findViewById(R.id.tabArea2)).setBackgroundColor(getResources().getColor(R.color.multi_tab_dark_color));
            ((TextView) findViewById(R.id.tv2)).setTextColor(getResources().getColor(R.color.appThemeColor_TXT_1));
            ((TextView) findViewById(R.id.tv2)).setBackgroundColor(getResources().getColor(R.color.multi_tab_light_color));
            ((TextView) findViewById(R.id.tv2)).setText(generalFunc.retrieveLangLBl("", "LBL_MULTI_ROUTE"));

            ((TextView) findViewById(R.id.tv3)).setBackgroundColor(getResources().getColor(R.color.multi_tab_dark_color));
            ((LinearLayout) findViewById(R.id.tabArea3)).setBackgroundColor(getResources().getColor(R.color.multi_tab_dark_color));
