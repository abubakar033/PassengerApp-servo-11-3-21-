...
public class AppLoginActivity extends AppCompatActivity {
    ...
    TextView introductondetailstext, languageText, currancyText, loginbtn, registerbtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this,"Login Act",Toast.LENGTH_SHORT).show();
    ...
    private void initview() {
        ...
        introductondetailstext = (TextView) findViewById(R.id.introductondetailstext);
        languageText = (TextView) findViewById(R.id.languageText);
        currancyText = (TextView) findViewById(R.id.currancyText);
