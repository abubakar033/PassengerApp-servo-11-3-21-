...
public class EditCartActivity extends AppCompatActivity {
    ...
    TextView totalNoteTxt;
    CardView totalarea;

    RelativeLayout nocartarea;
    TextView nocartTitleTxt, nocartMsgTxt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        paymentMethod= (HashMap<String, String>) getIntent().getSerializableExtra("paymentMethod");
    ...
    public void initView() {
        ...
        vHotelNameTxt = (TextView) findViewById(R.id.vHotelNameTxt);
        vHotelAddressTxt = (TextView) findViewById(R.id.vHotelAddressTxt);
        ...
        totalVTxt = (TextView) findViewById(R.id.totalVTxt);
        totalHTxt = (TextView) findViewById(R.id.totalHTxt);
        mainScrollView = (ScrollView) findViewById(R.id.mainScrollView);
        btn_type2 = ((MaterialRippleLayout) findViewById(R.id.btn_type2)).getChildView();
        totalNoteTxt = (TextView) findViewById(R.id.totalNoteTxt);
        totalarea = (CardView) findViewById(R.id.totalarea);
        nocartarea = (RelativeLayout) findViewById(R.id.nocartarea);
        nocartTitleTxt = (TextView) findViewById(R.id.nocartTitleTxt);
        nocartMsgTxt = (TextView) findViewById(R.id.nocartMsgTxt);
        ...
        new CreateRoundedView(Color.parseColor("#FFFFFF"), 0, Utils.dipToPixels(getActContext(), 2), Color.parseColor("#dddddd"), restaurantImgContainerView);
            ...
            if (responseString != null && !responseString.equals("")) {
                ...
                if (GeneralFunctions.checkDataAvail(Utils.action_str, responseString) == true) {
                    ...
                    if (msg_obj != null) {
                        ...
                        Picasso.with(getActContext()).load(imageURL).placeholder(R.mipmap.ic_no_icon).fit().into(restaurantImgView);
                    }
    ...
    public void addItemView() {
        ...
        for (int i = 0; i < cartList.size(); i++) {
            ...
            TextView itemsubNameTxtView = (TextView) editCartView.findViewById(R.id.itemsubNameTxtView);
            ...
            TextView customizeTxtView = (TextView) editCartView.findViewById(R.id.customizeTxtView);
            TextView minusImgView = (TextView) editCartView.findViewById(R.id.minusImgView);
            TextView addImgView = (TextView) editCartView.findViewById(R.id.addImgView);
            View seperatorView = editCartView.findViewById(R.id.seperatorView);
            ImageView itemTypeImgView = (ImageView) editCartView.findViewById(R.id.itemTypeImgView);

            Cart itemData = cartList.get(pos);
            new CreateRoundedView(color, btnRadius, 0, strokeColor, minusImgView);
            new CreateRoundedView(color, btnRadius, 0, strokeColor, addImgView);

            if (generalFunc.isRTLmode()) {
                minusImgView.setRotation(180);
                addImgView.setRotation(180);
            }
    ...
    public void OpenOptionDailog(int pos, boolean isNew) {
        ...
        TextView optionTitleTxt = bottomSheetView.findViewById(R.id.optionTitleTxt);
        TextView topingTitleTxt = bottomSheetView.findViewById(R.id.topingTitleTxt);
        ...
        TextView vItemNameTxt = bottomSheetView.findViewById(R.id.vItemNameTxt);
        TextView vCancelTxt = bottomSheetView.findViewById(R.id.vCancelTxt);
...
//                            newCart.setQty(GeneralFunctions.parseIntegerValue(0, newCart.getQty()) + "");
    ...
    public void openRepeatDialog(int pos, int qty) {
        ...
        repeatCartDailog.setContentView(contentView, new ViewGroup.LayoutParams(ViewGroup.LayoutParams.FILL_PARENT,
                Utils.dpToPx(220, getActContext())));
        BottomSheetBehavior mBehavior = BottomSheetBehavior.from((View) contentView.getParent());
        mBehavior.setPeekHeight(Utils.dpToPx(220, getActContext()));
        ...
        TextView vItemNameTxt = (TextView) bottomSheetView.findViewById(R.id.vItemNameTxt);
        TextView price = (TextView) bottomSheetView.findViewById(R.id.price);
        TextView offerPrice = (TextView) bottomSheetView.findViewById(R.id.offerPrice);
        TextView repeatTitleTxt = (TextView) bottomSheetView.findViewById(R.id.repeatTitleTxt);
        TextView repeatItemTxt = (TextView) bottomSheetView.findViewById(R.id.repeatItemTxt);
        TextView newItemBtn = (TextView) bottomSheetView.findViewById(R.id.newItemBtn);
        TextView repeatItemBtn = (TextView) bottomSheetView.findViewById(R.id.repeatItemBtn);
        String itemList = "";
        ...
        exeWebServer.setDataResponseListener(responseString -> {
            ...
            if (responseString != null && !responseString.equals("")) {
                ...
                if (GeneralFunctions.checkDataAvail(Utils.action_str, responseString) == true) {
                    ...
                    bn.putBoolean("isFromEditCart", true);
                    bn.putBoolean("isFromEditCard", true);
                    bn.putString("iServiceId", realmCartList.get(0).getiServiceId());
                    generalFunc.storeData(Utils.iServiceId_KEY, realmCartList.get(0).getiServiceId());
                    new StartActProcess(getActContext()).startActWithData(PrescriptionActivity.class, bn);

                } else {
                    Bundle bn = new Bundle();
                    bn.putBoolean("isFromEditCard", true);
                    bn.putSerializable("paymentMethod",paymentMethod);
