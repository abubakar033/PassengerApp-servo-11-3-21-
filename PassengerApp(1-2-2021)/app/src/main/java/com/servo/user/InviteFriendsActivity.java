...
public class InviteFriendsActivity extends AppCompatActivity {
    ...
    TextView titleTxt, shareTxtLbl, invitecodeTxt, shareTxt;
    ...
    private void init() {
        ...
        shareTxtLbl = (TextView) findViewById(R.id.shareTxtLbl);
        invitecodeTxt = (TextView) findViewById(R.id.invitecodeTxt);
