...
public class FareEstimateActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    TextView searchLocTxt;
    TextView baseFareHTxt;
    TextView baseFareVTxt;
    TextView commisionHTxt;
    TextView commisionVTxt;
    TextView distanceTxt;
    TextView distanceFareTxt;
    TextView minuteTxt;
    TextView minuteFareTxt;
    TextView totalFareHTxt;
    TextView totalFareVTxt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchLocTxt = (TextView) findViewById(R.id.searchLocTxt);
        baseFareHTxt = (TextView) findViewById(R.id.baseFareHTxt);
        baseFareVTxt = (TextView) findViewById(R.id.baseFareVTxt);
        commisionHTxt = (TextView) findViewById(R.id.commisionHTxt);
        commisionVTxt = (TextView) findViewById(R.id.commisionVTxt);
        distanceTxt = (TextView) findViewById(R.id.distanceTxt);
        distanceFareTxt = (TextView) findViewById(R.id.distanceFareTxt);
        minuteTxt = (TextView) findViewById(R.id.minuteTxt);
        minuteFareTxt = (TextView) findViewById(R.id.minuteFareTxt);
        totalFareHTxt = (TextView) findViewById(R.id.totalFareHTxt);
        totalFareVTxt = (TextView) findViewById(R.id.totalFareVTxt);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        try {
            boolean success = gMapView.setMapStyle(
            ...
            if (responseString != null && !responseString.equals("")) {
                ...
                if (status.equals("OK")) {
                    ...
                    if (obj_routes != null && obj_routes.length() > 0) {
                        ...
                        ((TextView) findViewById(R.id.sourceLocTxt)).setText(generalFunc.getJsonValueStr("start_address", obj_legs));
                        ((TextView) findViewById(R.id.destLocTxt)).setText(generalFunc.getJsonValueStr("end_address", obj_legs));
            ...
            if (responseObj != null && !responseObj.equals("")) {
                ...
                if (isDataAvail == true) {
                    ...
                    if (!MinFareDiff.equals("") && !MinFareDiff.equals("0")) {
                        ...
                        ((TextView) findViewById(R.id.minFareHTxt)).setText(currency_sign + "" + total_fare + " "
                                + generalFunc.retrieveLangLBl("", "LBL_MINIMUM"));
                        ((TextView) findViewById(R.id.minFareVTxt)).setText(currency_sign + " " + total_fare);
                    }
                    ...
                    if (gMapView != null) {
                        ...
                        if (lineOptions != null) {
                            ...
                            gMapView.addPolyline(lineOptions);// done is one
                        }
