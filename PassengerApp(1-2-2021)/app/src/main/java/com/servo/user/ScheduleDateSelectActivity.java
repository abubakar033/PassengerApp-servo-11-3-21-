...
public class ScheduleDateSelectActivity extends AppCompatActivity implements TimeSlotAdapter.setRecentTimeSlotClickList, DatesRecyclerAdapter.OnDateSelectListener {
    ...
    TextView monthTxt;
    MButton btn_type2;
    TextView AddressTxtView, serviceAddrHederTxtView;
    String address = "";
    String latitude = "";
    String longitude = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        while (currentTempDate.before(endDate.getTime())) {
            ...
            hashMap.put("dayNumTxt", dayNumFormatter.format(currentTempDate));
        ...
        exeWebServer.setDataResponseListener(responseString -> {
            ...
            if (responseString != null && !responseString.equals("")) {
                ...
                if (isDataAvail) {
                    ...
                    if (ismain || (getCallingActivity() != null && getCallingActivity().getClassName().equals(CarWashBookingDetailsActivity.class.getName())) || (SERVICE_PROVIDER_FLOW.equalsIgnoreCase("Provider") && getCallingActivity() != null && getCallingActivity().getClassName().equals(HistoryActivity.class.getName()))) {
