                ...
                if (isDataAvail) {
                    ...
                    if (itemArray!=null) {
                        ...
                        for (int i = 0; i < itemArray.length(); i++) {
                            ...
                            TextView serviceNameTxt = (TextView) editCartView.findViewById(R.id.serviceNameTxt);
                            TextView qtyTxt = (TextView) editCartView.findViewById(R.id.qtyTxt);
                            TextView commentHTxt = (TextView) editCartView.findViewById(R.id.commentHTxt);
                            TextView commentVTxt = (TextView) editCartView.findViewById(R.id.commentVTxt);
