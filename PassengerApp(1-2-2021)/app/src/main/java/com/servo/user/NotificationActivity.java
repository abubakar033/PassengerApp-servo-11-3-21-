    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (generalFunc.getJsonValue("ENABLE_NEWS_SECTION", userProfileJson).equalsIgnoreCase("Yes")) {
            ...
            if (generalFunc.isRTLmode()) {
                ...
                titles = new CharSequence[]{generalFunc.retrieveLangLBl("all", "LBL_NEWS"),
                        generalFunc.retrieveLangLBl("", "LBL_NOTIFICATIONS"),
                        generalFunc.retrieveLangLBl("news", "LBL_ALL")};
                ...
                titles = new CharSequence[]{generalFunc.retrieveLangLBl("all", "LBL_ALL"),
                        generalFunc.retrieveLangLBl("", "LBL_NOTIFICATIONS"), generalFunc.retrieveLangLBl("news", "LBL_NEWS")};
                material_tabs.setVisibility(View.VISIBLE);
                fragmentList.add(generateNotificationFrag(Utils.All));
                fragmentList.add(generateNotificationFrag(Utils.Notificatons));
                fragmentList.add(generateNotificationFrag(Utils.News));
