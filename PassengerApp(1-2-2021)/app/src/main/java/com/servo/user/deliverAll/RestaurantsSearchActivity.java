...
public class RestaurantsSearchActivity extends AppCompatActivity implements RestaurantSearchAdapter.RestaurantOnClickListener {
    ...
    public void initView() {
        ...
        cusineTitleTxt = (TextView) findViewById(R.id.cusineTitleTxt);
                    ...
                    if (isDataAvail == true) {
                        ...
                        if (restaurant_Arr != null)
                        {
                            ...
                            for (int i = 0; i < restaurant_Arr.length(); i++) {
                                ...
                                map.put("Restaurant_MinOrderValue", generalFunc.getJsonValueStr("Restaurant_MinOrderValue", restaurant_Obj));
                                ...
                                if (!generalFunc.getJsonValueStr("vImage", restaurant_Obj).trim().equalsIgnoreCase("")){
    ...
    public void addCusineView() {
        ...
        if (cuisineList != null && cuisineList.size() > 0) {
            ...
            for (int i = 0; i < cuisineList.size(); i++) {
                ...
                TextView cusineName = (TextView) view.findViewById(R.id.cusineName);
                TextView totalRest = (TextView) view.findViewById(R.id.totalRest);
