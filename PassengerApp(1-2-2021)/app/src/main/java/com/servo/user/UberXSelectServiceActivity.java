                ...
                if (responseObj != null && !responseObj.equals("")) {
                    ...
                    if (isDataAvail == true) {
                        ...
                        if (!vCategoryTitle.trim().equals("")) {
                            ((TextView) findViewById(R.id.vCategoryTitleTxtView)).setText(Html.fromHtml(vCategoryTitle.replace("\r\n", "<br/>")));
                        } else {
                        ...
                        if (!vCategoryDesc.trim().equals("")) {
                            ((TextView) findViewById(R.id.descTxtView)).setText(Html.fromHtml(vCategoryDesc.replace("\r\n", "<br/>")));

                            if (viewMoreSet == false) {
                                generalFunc.makeTextViewResizable((TextView) findViewById(R.id.descTxtView), 6, "...\n+ " + generalFunc.retrieveLangLBl("View More", "LBL_VIEW_MORE_TXT"), true, R.color.appThemeColor_1, R.dimen.txt_size_16);
                                viewMoreSet = true;
                            }
                        } else {
                        ...
                        if (mainCataArray!=null) {
                            ...
                            for (int i = 0; i < mainCataArray.length(); i++) {
                                ...
                                ((TextView) findViewById(R.id.vCategoryTitleTxtView)).setText(Html.fromHtml(generalFunc.getJsonValueStr("vCategoryTitle", mainCataObject)));


                                ((TextView) findViewById(R.id.selectServiceTxtView)).setText(getIntent().getStringExtra("vCategoryName"));
                                ...
                                final TextView QTYTxtView = (TextView) view.findViewById(R.id.QTYTxtView);
                                final TextView QTYNumberTxtView = (TextView) view.findViewById(R.id.QTYNumberTxtView);
                                final TextView priceTxtView = (TextView) view.findViewById(R.id.priceTxtView);
                                ...
                                if (!fMinHour.equalsIgnoreCase("") && Integer.parseInt(fMinHour) > 1) {
                                    ((TextView) view.findViewById(R.id.minHourTxtView)).setText("" + "(" + LBL_MINIMUM_TXT + " " + fMinHour + " " + LBL_HOURS_TXT + ")");
                                }//
...
//                          FARE DETAILS AREA START
                                ...
                                ((TextView) view.findViewById(R.id.fPricePerKMValueTxtView)).setText(fPricePerKM);
                                ((TextView) view.findViewById(R.id.fPricePerMinValueTxtView)).setText(fPricePerMin);
                                ((TextView) view.findViewById(R.id.iBaseFareValueTxtView)).setText(iBaseFare);
                                ((TextView) view.findViewById(R.id.iMinFareValueTxtView)).setText(iMinFare);


                                if (generalFunc.getJsonValue("eUnit", userProfileJson).equals("KMs")) {
                                    ((TextView) view.findViewById(R.id.fPricePerKMTxt)).setText(LBL_PRICE_PER_KM);
                                } else {
                                    ((TextView) view.findViewById(R.id.fPricePerKMTxt)).setText(LBL_PRICE_PER_MILES);
                                }
                                ((TextView) view.findViewById(R.id.fPricePerMinTxt)).setText(LBL_PRICE_PER_MINUTE);
                                ((TextView) view.findViewById(R.id.iBaseFareTxt)).setText(LBL_BASE_FARE_SMALL_TXT);
                                ((TextView) view.findViewById(R.id.iMinFareTxt)).setText(LBL_MIN_FARE);
...
//                          OVER FARE DETAILS AREA
                                ...
                                ((TextView) view.findViewById(R.id.fareHeadingTxtView)).setText("" + LBL_FARE_DETAIL_TXT);
        ...
        public void onClick(View v) {
            try {
                ...
                if (listOfView != null && listOfView.size() > 0 && listOfView.get(selectedVehiclePosition) != null &&
                    ...
                    quantity = ((TextView) listOfView.get(selectedVehiclePosition).findViewById(R.id.QTYNumberTxtView)).getText().toString();
                    QUANTITYPrice = ((TextView) listOfView.get(selectedVehiclePosition).findViewById(R.id.priceTxtView)).getText().toString();
                }
