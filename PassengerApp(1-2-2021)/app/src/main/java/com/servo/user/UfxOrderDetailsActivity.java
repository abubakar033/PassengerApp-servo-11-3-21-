...
public class UfxOrderDetailsActivity extends AppCompatActivity {
    ...
    TextView serviceItemname, servicepriceTxtView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        serviceItemname = (TextView) findViewById(R.id.serviceItemname);
        servicepriceTxtView = (TextView) findViewById(R.id.servicepriceTxtView);
