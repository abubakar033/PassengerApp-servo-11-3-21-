...
import com.servo.user.deliverAll.CheckOutActivity;
...
public class PrescriptionActivity extends AppCompatActivity implements GalleryImagesRecyclerAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        attechTxt = (TextView) findViewById(R.id.attechTxt);
        carouselContainerView = findViewById(R.id.carouselContainerView);
        carouselView = (CarouselView) findViewById(R.id.carouselView);
        noteTxt = (TextView) findViewById(R.id.noteTxt);
        noDescTxt = (TextView) findViewById(R.id.noDescTxt);
        closeCarouselTxtView = (TextView) findViewById(R.id.closeCarouselTxtView);
...
//        return Uri.fromFile(getOutputMediaFile(type));
    ...
    class ImageSourceDialog implements Runnable {
        ...
        public void run() {
            ...
            TextView cameraTxt = (TextView) dialog_img_update.findViewById(R.id.cameraTxt);
            TextView galleryTxt = (TextView) dialog_img_update.findViewById(R.id.galleryTxt);
            TextView prescriptionTxt = (TextView) dialog_img_update.findViewById(R.id.prescriptionTxt);
