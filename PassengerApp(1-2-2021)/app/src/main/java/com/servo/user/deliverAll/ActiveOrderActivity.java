                ...
                if (action.equals("1")) {
                    ...
                    if(message_arr != null){
                        ...
                        for (int i = 0; i < message_arr.length(); i++) {
                            ...
                            map.put("deliveryType", generalFunc.getJsonValueStr("deliveryType", addr_obj));
                            ...
                            map.put("vImage", Utils.getResizeImgURL(getActContext(), generalFunc.getJsonValueStr("vImage", addr_obj),
                                    user_profile_icon_size_main, user_profile_icon_size_main));
