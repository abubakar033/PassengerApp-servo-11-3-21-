...
public class FoodRatingActivity extends AppCompatActivity {
    ...
    TextView titleTxt;
    TextView ratingResNameTxt, ratingDriverNameTxt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ratingResNameTxt = (TextView) findViewById(R.id.ratingResNameTxt);
        ratingDriverNameTxt = (TextView) findViewById(R.id.ratingDriverNameTxt);
        ...
        titleTxt.setText(generalFun.retrieveLangLBl("", "LBL_RATING") + "(" + generalFun.retrieveLangLBl("", "LBL_ORDER") + "#" + generalFun.getJsonValue("LastOrderNo", userProfileJson) + ")");
