...
public class EmergencyContactActivity extends AppCompatActivity implements EmergencyContactRecycleAdapter.OnItemClickList {
    ...
    public void setLabels() {
        ...
        if (generalFunc.getJsonValue("APP_TYPE", userprofilejson).equalsIgnoreCase(Utils.CabGeneralTypeRide_Delivery_UberX)) {
            ((TextView) findViewById(R.id.emeTitleTxt)).setText(generalFunc.retrieveLangLBl("", "LBL_FOR_SAFETY"));
        } else {
            ((TextView) findViewById(R.id.emeTitleTxt)).setText(generalFunc.retrieveLangLBl("", "LBL_EMERGENCY_CONTACT_TITLE"));
        }
        ((TextView) findViewById(R.id.emeSubTitleTxt1)).setText(generalFunc.retrieveLangLBl("", "LBL_EMERGENCY_CONTACT_SUB_TITLE1"));
        ((TextView) findViewById(R.id.emeSubTitleTxt2)).setText(generalFunc.retrieveLangLBl("", "LBL_EMERGENCY_CONTACT_SUB_TITLE2"));
        ((TextView) findViewById(R.id.notifyTxt)).setText(generalFunc.retrieveLangLBl("", "LBL_ADD_EMERGENCY_UP_TO_COUNT"));
