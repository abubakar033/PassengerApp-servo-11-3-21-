...
public class BusinessSelectPaymentActivity extends AppCompatActivity {
    ...
    TextView titleTxt, profileheadingTxt, paymentheadingTxt, orgnizationNameTxt;
    ...
    TextView commentHname;
    MaterialEditText commentBox;
    TextView reasonheadingTxt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profileheadingTxt = (TextView) findViewById(R.id.profileheadingTxt);
        paymentheadingTxt = (TextView) findViewById(R.id.paymentheadingTxt);
        ...
        addWalletTxt = (TextView) findViewById(R.id.addWalletTxt);
        ...
        reasonNameTxt = (TextView) findViewById(R.id.reasonNameTxt);
        ...
        reasonheadingTxt = (TextView) findViewById(R.id.reasonheadingTxt);
        ...
        if (ePaymentBy.equalsIgnoreCase("Passenger") || !ePaymentBy.equalsIgnoreCase("Organization")) {
            ...
            if (vImage != null && !vImage.equalsIgnoreCase("")) {
                if (vImage.equalsIgnoreCase(generalFunc.retrieveLangLBl("", "Personal"))) {
                    ...
                    Picasso.with(getActContext()).load(vImage).placeholder(R.mipmap.ic_no_icon).into(profileImage);
                }
            }
        } else {
