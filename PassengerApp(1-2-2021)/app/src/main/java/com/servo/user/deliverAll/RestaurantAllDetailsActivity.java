...
public class RestaurantAllDetailsActivity extends AppCompatActivity implements AppBarLayout.OnOffsetChangedListener, BiodataExpandable.ChildItemClickListener {
    ...
    TextView titleFoodTxt, foodAddresstxt;
    ...
    TextView miniOrderTtxt, miniOrderVtxt, deliverinTtxt, deliverinVtxt, selectServiceTxt;

    String eNonVegToggleDisplay = "";
    TextView openingHourTxt, timeHTxt, timeVTxt, titleDailogTxt, addressDailogTxt;
    ImageView coverImage;
    LinearLayout offerArea;

    TextView offerMsgTxt;
    View viewofferLine;
    String vCompany = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this,"old resrt",Toast.LENGTH_LONG).show();
