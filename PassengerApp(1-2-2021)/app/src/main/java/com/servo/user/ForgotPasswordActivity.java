...
public class ForgotPasswordActivity extends AppCompatActivity implements GenerateAlertBox.HandleAlertBtnClick {
    ...
    TextView forgotpasswordHint, forgotpasswordNote, backbtn;
    MButton btn_type2;
    int submitBtnId;
    ...
    private void initView() {
        ...
        forgotpasswordHint = (TextView) findViewById(R.id.forgotpasswordHint);
        forgotpasswordNote = (TextView) findViewById(R.id.forgotpasswordNote);
