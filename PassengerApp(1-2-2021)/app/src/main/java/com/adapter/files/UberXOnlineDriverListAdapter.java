...
public class UberXOnlineDriverListAdapter extends RecyclerView.Adapter<UberXOnlineDriverListAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        if (fAmount != null && !fAmount.trim().equals("") && !fAmount.trim().equals("0")) {
            viewHolder.priceTxt.setText(fAmount);
        } else {
        ...
        if (item.get("eIsFeatured").equalsIgnoreCase("Yes")) {
            ...
            if (!LANGUAGE_IS_RTL_KEY.equals("") && LANGUAGE_IS_RTL_KEY.equals(Utils.DATABASE_RTL_STR)) {
                ...
                viewHolder.triangleView.setRotation(180);
            ...
            viewHolder.triangleView.setVisibility(View.GONE);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            driverNameTxt = (TextView) view.findViewById(R.id.driverNameTxt);
            ...
            milesTxt = (TextView) view.findViewById(R.id.milesTxt);
            ...
            labelFeatured = (TextView) view.findViewById(R.id.labelFeatured);
            cardArea = (LinearLayout) view.findViewById(R.id.cardArea);
            triangleView = (ImageView) view.findViewById(R.id.triangleView);
