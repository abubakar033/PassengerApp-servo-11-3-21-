...
//            viewHolder.liveTrackBtnArea.setVisibility(View.GONE);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private TextView bookingNoLblTxt;
        private TextView bookingNoTxt;
        private TextView bookingDateTxt, etypeTxt;
        ...
        private TextView SelectedTypeNameTxt;
        private TextView viewDetailsBtn;
        private TextView liveTrackBtn;
        ...
        public ViewHolder(View view) {
            ...
            userAddressTxt = (TextView) view.findViewById(R.id.userAddressTxt);
            bookingNoLblTxt = (TextView) view.findViewById(R.id.bookingNoLblTxt);
            bookingDateTxt = (TextView) view.findViewById(R.id.bookingDateTxt);
            etypeTxt = (TextView) view.findViewById(R.id.etypeTxt);
            bookingNoTxt = (TextView) view.findViewById(R.id.bookingNoTxt);
            ...
            viewDetailsBtn = (TextView) view.findViewById(R.id.viewDetailsBtn);
            liveTrackBtn = (TextView) view.findViewById(R.id.liveTrackBtn);
        }
    }
