...
public class WalletHistoryRecycleAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private TextView tranasctionBalVTxt;
        private TextView transactiondateTxt;
        private TextView transactionDesVTxt;
        ...
        public ViewHolder(View view) {
            ...
            tranasctionBalVTxt = (TextView) view.findViewById(R.id.tranasctionBalVTxt);
            transactiondateTxt = (TextView) view.findViewById(R.id.transactiondateTxt);
            transactionDesVTxt = (TextView) view.findViewById(R.id.transactionDesVTxt);
