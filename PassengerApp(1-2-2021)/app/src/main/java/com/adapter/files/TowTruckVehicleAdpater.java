...
public class TowTruckVehicleAdpater extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public TextView vehicleNameTxtView;
        public TextView vehicleColorNameTxtView;
        ...
        public ViewHolder(View view) {
            ...
            vehicleNameTxtView = (TextView) view.findViewById(R.id.vehicleNameTxtView);
            vehicleColorNameTxtView = (TextView) view.findViewById(R.id.vehicleColorNameTxtView);
