...
public class UberXCategoryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
   ...
   // ArrayList<HashMap<String, String>> list_item_banner;
    Context mContext;
    OnItemClickListDataRecucler onItemClickList;
    ...
    int margin;
    int grid;
   // ArrayList<HashMap<String, String>> Service_list_item1;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
     ...
     //   getBannerList();
        if (viewType == TYPE_BANNER) {
            ...
            // View view = LayoutInflater.from(parent.getContext()).inflate(CAT_TYPE_MODE.equals("0") ? R.layout.j_delivery_services_vertical_layout : R.layout.item_uberx_cat_list_design, parent, false);
...
//        String vDecription = item.get("");
        ...
        if (parentViewHolder instanceof ViewHolder) {
            ...
            if (vCategory.matches("\\w*")) {
               ...
               // viewHolder.uberXCatDescription.setText("");
            ...
            viewHolder.contentArea.setOnClickListener(view -> {
                if (CAT_TYPE_MODE.equalsIgnoreCase("0")) {
                    if (onItemClickList != null) {
                        onItemClickList.onItemClickdata(position);
                    }
                } else {
                    if (ismultiSelect) {
   ...
   // }
    ...
    public void setOnItemClickList(OnItemClickListDataRecucler onItemClickList) {
        this.onItemClickList = onItemClickList;
    }

    public interface OnItemClickListDataRecucler {
