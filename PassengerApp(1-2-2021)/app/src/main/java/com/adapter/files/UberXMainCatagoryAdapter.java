...
public class UberXMainCatagoryAdapter extends RecyclerView.Adapter<UberXMainCatagoryAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, final int position) {
        ...
        Picasso.with(mContext).load(map.get("vLogo_image")).into(viewHolder.uberXcategoryImgView);
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public TextView uberXcategoryNameTxtView;
        public LinearLayout contentArea;

        public ViewHolder(View itemView) {
            super(itemView);
            uberXcategoryImgView = (ImageView) itemView.findViewById(R.id.uberXcategoryImgView);
            uberXcategoryNameTxtView = (TextView) itemView.findViewById(R.id.uberXcategoryNameTxtView);
