...
import com.servo.user.MultiDeliveryThirdPhaseActivity;
...
public class MultiPaymentTypeRecyclerAdapter extends RecyclerView.Adapter<MultiPaymentTypeRecyclerAdapter.ViewHolder> implements MultiListViewAdapter.OnItemClickListener {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        if (PaymentDoneBy.equalsIgnoreCase(Payment_Type_2)) {
        ...
        if (holder.radioBtn.isChecked() && PaymentDoneBy.equalsIgnoreCase(Payment_Type_2)) {
            holder.paymentDetailArea.setVisibility(View.VISIBLE);
        } else {
            holder.paymentDetailArea.setVisibility(View.GONE);
        }

        if (holder.radioBtn.isChecked() && PaymentDoneBy.equalsIgnoreCase(mActivity.Payment_Type_3)) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            containerView = view;
            typeTitleTxt = (TextView) view.findViewById(R.id.typeTitleTxt);
            typeInstTxt = (TextView) view.findViewById(R.id.typeInstTxt);
