...
//			convertView.setAlpha((float) 0.96);
            ...
            headingTxt.setTextColor(mContext.getResources().getColor(R.color.appThemeColor_1));
            headingTxt.setText(categoryListItem.text);
            headingTxt.setPaddingRelative(padding, padding, padding1, padding1);
            ...
            descTxt.setText(Html.fromHtml(categoryListItem.getvDesc()));
            headingTxt.setText(categoryListItem.getvTitle());

            if (categoryListItem.isAdd) {
                bookRemoveTxt.setText(LBL_REMOVE_SERVICE);
            } else {
                bookRemoveTxt.setText(LBL_BOOK_SERVICE);
            }
...
//				Toast.makeText(mContext, "hi--" + countryListItem.text, Toast.LENGTH_LONG).show();
        ...
        bookRemoveTxt.setOnClickListener(new OnClickListener() {
            @Override
