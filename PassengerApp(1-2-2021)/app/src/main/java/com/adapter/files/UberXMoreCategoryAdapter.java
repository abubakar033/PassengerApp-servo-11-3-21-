...
public class UberXMoreCategoryAdapter extends RecyclerView.Adapter<UberXMoreCategoryAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, final int position) {
        ...
        Picasso.with(mContext).load(vLogo_image.equals("") ? CommonUtilities.SERVER : vLogo_image).placeholder(R.mipmap.ic_no_icon).into(viewHolder.catImgView, new Callback() {
            @Override
