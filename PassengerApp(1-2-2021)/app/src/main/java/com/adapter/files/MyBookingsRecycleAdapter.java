...
//        footerHolder.progressArea.setPadding(0, -1 * footerView.getHeight(), 0, 0);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            int submitBtnId;
            int bookingBtnId;
            myBookingNoHTxt = (TextView) view.findViewById(R.id.myBookingNoHTxt);
            myBookingNoVTxt = (TextView) view.findViewById(R.id.myBookingNoVTxt);
            ...
            cancelBookingTxt = (TextView) view.findViewById(R.id.cancelBookingTxt);
