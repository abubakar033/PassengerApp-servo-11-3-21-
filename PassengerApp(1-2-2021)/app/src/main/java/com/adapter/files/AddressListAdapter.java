...
//            viewHolder.deliveryAddrArea.setBackgroundColor(Color.parseColor("#dadada"));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ImageView radioImg;
        TextView vAreaTxt;
        TextView tAddressTxt;
        TextView vCityTxt;
        TextView vPostcodeTxt;
        TextView vContryTxt;
        TextView vApartmentTxt;
        TextView addressNotAvailTxtView;
        ImageView imgdelete;
        ...
        public ViewHolder(View itemView) {
            ...
            vAreaTxt = (TextView) itemView.findViewById(R.id.vAreaTxt);
            tAddressTxt = (TextView) itemView.findViewById(R.id.tAddressTxt);
            vCityTxt = (TextView) itemView.findViewById(R.id.vCityTxt);
            vPostcodeTxt = (TextView) itemView.findViewById(R.id.vPostcodeTxt);
            vContryTxt = (TextView) itemView.findViewById(R.id.vContryTxt);
            vApartmentTxt = (TextView) itemView.findViewById(R.id.vApartmentTxt);
            addressNotAvailTxtView = (TextView) itemView.findViewById(R.id.addressNotAvailTxtView);
