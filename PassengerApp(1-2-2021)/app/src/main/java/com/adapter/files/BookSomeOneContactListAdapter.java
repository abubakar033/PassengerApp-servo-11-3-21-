...
import com.servo.user.BookSomeOneElsePickContactActivity;
...
public class BookSomeOneContactListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements Filterable {
    ...
    private void setData(RecyclerView.ViewHolder holder, final int position) {
        if (SECTION_VIEW == getItemViewType(position)) {
            ...
            if (vContactID.equalsIgnoreCase("0")) {
                ...
                Picasso.with(mContext).load(item.photoURI != null && item.photoURI.startsWith("http") ? item.photoURI : CommonUtilities.USER_PHOTO_PATH).into(viewHolder.contactProfileImgView, new Callback() {
                    @Override
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView contactNameTxt, nameTxt;
        ...
        public ViewHolder(View itemView) {
            ...
            contactNameTxt = (TextView) itemView.findViewById(R.id.contactNameTxt);
            contactNoTxt = (TextView) itemView.findViewById(R.id.contactNoTxt);
    ...
    public class SectionHeaderViewHolder extends RecyclerView.ViewHolder {
        ...
        public SectionHeaderViewHolder(@NonNull View itemView) {
            super(itemView);
            headerTitleTxt = (TextView) itemView.findViewById(R.id.headerTitleTxt);
        }
    }
